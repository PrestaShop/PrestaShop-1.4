...
function smartyAutoload($class)
{
    ...
    /* PrestaShop */
    if (substr($_class, 0, 16) === 'smarty_internal_' || isset($_classes[$_class]) || $_class == 'smarty_security' && file_exists(SMARTY_SYSPLUGINS_DIR.$_class.'.php')) {
