			...
			try{
				...
				if (!$bool_save)
					$this->_errors[] = $this->l('Authentication failed.')."<br />\n"
						.$this->l('After subscribing please check the email sent by Twenga. If there is still error, contact Twenga customer service.');
				else
...
//		$params_to_twenga['cli_email'] = $customer->email;
	...
	public function displayTwengaIntro()
	{
		...
		$str_return = '
			...
			<fieldset>
				<legend><img src="../modules/'.$this->name.'/logo.gif" class="middle" /> '.$this->l('Get your products listed on Twenga.co.uk and follow sales generated by Twenga').'</legend>'
	...
	private function displaySubscription()
	{
		...
		<fieldset>
			...
			<div class="margin-form">
				...
				<p>'
				.$this->l('E-Merchants country. Use the ISO_3166-1 Alpha-2 country code format.')
				.'<br />
