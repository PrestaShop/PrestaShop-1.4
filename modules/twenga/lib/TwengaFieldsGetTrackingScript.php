...
//            $this->fields['PARTNER_AUTH_KEY'] = array(56, array('isString', 'isCleanHtml'), true);
            ...
            // optionnals
            $this->fields['currency'] = array(40, array('isString','isCleanHtml'));
            ...
            $this->fields['cli_firstname'] = array(0, array('isString','isCleanHtml'));
            $this->fields['cli_lastname'] = array(0, array('isString','isCleanHtml'));
            $this->fields['cli_city'] = array(0, array('isString','isCleanHtml'));
            $this->fields['cli_state'] = array(0, array('isString','isCleanHtml'));
            $this->fields['cli_country'] = array(0, array('isString','isCleanHtml'));
            $this->fields['cli_segment'] = array(0, array('isString','isCleanHtml'));
            $this->fields['payement_method'] = array(0, array('isString','isCleanHtml'));
