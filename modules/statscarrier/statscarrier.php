...
class StatsCarrier extends ModuleGraph
{
	...
	public function hookAdminStatsModules($params)
	{
		...
		<fieldset class="width3">
			<legend><img src="../modules/'.$this->name.'/logo.gif" alt="" /> '.$this->displayName.'</legend>
		...
		$this->_html .= '</select>
			...
			<p><img src="../img/admin/down.gif" alt="" />'.$this->l('This graph represents the distribution of carriers for your orders. You can also limit it to orders in one state.').'</p>
			<center>'.($result['total'] ? ModuleGraph::engine(array('type' => 'pie', 'option' => Tools::getValue('id_order_state'))).'</center><br /><br />	<a href="'.Tools::safeOutput($_SERVER['REQUEST_URI']).'&export=1&exportType=language"><img src="../img/admin/asterisk.gif" alt="" />'.$this->l('CSV Export').'</a>' : $this->l('No valid orders for this period.')).'
		</fieldset>';
