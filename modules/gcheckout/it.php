...
$_MODULE['<{gcheckout}prestashop>gcheckout_cdd506f9916fb2a6c2a901eb79928176'] = 'In primo luogo, utilizza la pagina per testare il modulo, poi puoi utilizzare la modalità reale se va tutto bene. Non dimenticare di cambiare la chiave e l\'ID commerciante secondo la modalità!';
...
$_MODULE['<{gcheckout}prestashop>gcheckout_df3d5f610e4df12f30da88694a6c6cc8'] = 'Se si spunta questa casella, gli acquirenti saranno in grado di vedere le spese di spedizione che hai configurato in Google Checkout nella pagina di acquisto.';
...
$_MODULE['<{gcheckout}prestashop>gcheckout_ce103162a276684df5afb8221cfa0469'] = 'Se lo attivi, assicurati di proteggerli mettendo un file. Htaccess nella stessa directory. Se dimentichi di farlo, sarà leggibile da tutti';
...
$_MODULE['<{gcheckout}prestashop>gcheckout_c4ddab20febbb0e75bb211ac8cd4c541'] = 'Per poter utilizzare il modulo Google Checkout, è necessario configurare il tuo account Google Checkout (account sandbox così come account live). Accedi a Google Checkout poi vai su Settings > Integration. L\'URL callback API è:';
$_MODULE['<{gcheckout}prestashop>gcheckout_dba727a9adc372723baef4533a7fc9da'] = 'Il metodo di callback deve essere impostato su';
$_MODULE['<{gcheckout}prestashop>gcheckout_11c77d80d50637745db285b9f2d68a96'] = 'Gli ordini devono essere posizionati con la stessa valuta del tuo account venditore. Carrelli in altre valute saranno convertiti se il cliente sceglie di pagare con questo modulo.';
