	...
	public function displayFormSettings()
	{
		...
		<!--<br/>
				<fieldset><legend>'.$this->l('Test account').'</legend>
					...
					<div class="margin-form"><input type="text" name="merchidtest" id="merchidtest" value="'.$merchidtest.'" size="10" /></div>
					<label for="cryptkeytest">'.$this->l('Crypt key').'</label>
					<div class="margin-form"><input type="text" name="cryptkeytest" id="cryptkeytest" value="'.$cryptkeytest.'" size="40" /></div>
				</fieldset>-->
			<br/>
		<fieldset>
