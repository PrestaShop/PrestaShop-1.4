...
{if $direct}
	<p class="payment_module">
		...
		{l s='Kwixo via debit card in one time. It is simple, convenient and secure.' mod='kwixo'}
...
{if $comptant}
	<p class="payment_module">
		<b><a href="{$modules_dir}kwixo/sendtoRNP.php?payment=1"><img width="115" src="{$modules_dir}kwixo/logoKwixo_PAR_V.png" /> 
			{l s='Kwixo via debit card in one time. Allows payment after receiving order.' mod='kwixo'}
...
{if $credit}
	<p class="payment_module">
		...
		{l s='Kwixo via instalments. Allows payment after receiving order.' mod='kwixo'}
