...
<div id="editorial_block_center" class="editorial_block">
	...
	{if $editorial->body_logo_subheading}<p>{$editorial->body_logo_subheading|stripslashes}</p>
	{elseif $editorial->body_logo_subheading}<p>{$editorial->body_logo_subheading}</p>{/if} 
