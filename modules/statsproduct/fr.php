...
$_MODULE['<{statsproduct}prestashop>statsproduct_7b30da57e53253248663e9913b5e5679'] = 'Après avoir choisi une catégorie et sélectionné un produit disponible dans cette catégorie, des graphiques apparaissent. Vous pouvez ensuite les analyser.';
$_MODULE['<{statsproduct}prestashop>statsproduct_02a9ec23cfb48cf0e7aa552bd1fb50d0'] = 'Si vous constatez qu\'un produit a du succès, qu\'il est beaucoup acheté mais très peu consulté : vous devriez le mettre davantage en évidence dans la vitrine de votre boutique.';
$_MODULE['<{statsproduct}prestashop>statsproduct_2b08d628bb719ed986cb9aa5fd49bd5f'] = 'Si au contraire un produit connait un grand nombre de consultations mais est très peu acheté : nous vous conseillons alors de vérifier à nouveau ou de modifier les informations, description ou photographie(s) présentes dans sa fiche produit.';
