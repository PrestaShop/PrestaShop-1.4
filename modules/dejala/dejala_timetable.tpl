...
<tr style="border-top: 0px solid #bdc2c9;">
	<td colspan="4" style="border-top: 0px solid #bdc2c9;">
		
		<div id="shipping_pref" {if $carrier.id_carrier != $checked}style="display:none;"{/if}>
			<div id="shipping_div">
				<div id="shipping_dates">
					<label class="title">{l s='Choisissez le jour de la livraison' mod='dejala'}:</label><br class="clear"/>
				...
				<div id="shipping_hours">
					<label class="title">{l s='Choisissez l\'heure de la livraison' mod='dejala'}:</label><br class="clear"/>
