			...
			<table class="std">
				...
				<tr>
					...
					<td class="align_center">
						<a href="modules/mailalerts/myalerts.php?action=delete&id_product={$product.id_product}&id_product_attribute={$product.id_product_attribute}"><img src="modules/mailalerts/img/delete.gif" alt="{l s='Delete' mod='mailalerts'}" /></a>
					</td>
				</tr>
				</tbody>
			{/foreach}
