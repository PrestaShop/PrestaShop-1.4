...
class psaDisasterComment extends ObjectModel
{
 	/** @var string Name */
	public 		$name;
	...
	{		
		if (parent::delete())
		{
			/* Delete all comments associate */
			return Db::getInstance()->Execute('DELETE FROM '._DB_PREFIX_.'carrier_zone WHERE id_zone = '.(int)$this->id);
		}
