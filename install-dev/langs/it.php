...
$_LANG['Prestashop and its community offers over 60 different languages for free download at'] = 'Prestashop e la sua comunità propongono più di 60 lingue diverse in download gratuito su';
...
$_LANG['Create a MySQL database using phpMyAdmin (or by asking your hosting provider)'] = 'Crea una database MySQL utilizzando phpMyAdmin (o chidendo al tuo hosting provider)';
$_LANG['- or -'] = '- o -';
...
$_LANG['Your current version is too old, updates are possible only from version'] =  'La tua versione attuale è troppo vecchia, I aggiornamenti sono possibili solo sulle versioni';
$_LANG['and higher'] = 'e più recenti';
$_LANG['PHP settings (for assistance, ask your hosting provider):'] =  'impostazioni PHP (per aiuto, chiedi al tuo hosting provider)';
$_LANG['Database Configuration'] = 'Configurazione database';
$_LANG['Database login:'] = 'login database';
$_LANG['Database password:'] = 'password database';
$_LANG['Please create a MySQL database and then verify your settings below. If you need assistance, please ask your hosting provider for this information.'] = 'Si prega di creare una database MySQL e verificare le tue impostazioni qui sotto. Se serve aiuto, si prega di chiedere queste informazioni al tuo hosting provider';
$_LANG['Ok, please deactivate the following modules, I will reactivate them later:'] = 'Ok, si prega di disattivare I moduli seguenti, li riattivero più tardi';
$_LANG['You will be able to manually reactivate them in your Back Office once the update process has succeeded.'] = 'Potrai riattivarli nel tuo Back Office una volta l\'aggiornamento riuscito';
$_LANG['No more information'] = 'nessun\'altra informazione';
$_LANG['If your theme is not valid, you may experience some problems in your front-office aspect, but don\'t panic ! To solve this, you can make it compatible by correcting the validators errors or by using a theme compatible with '] = 'Se il tema non è valido, possono verificarsi problem nell\'aspetto del tuo Front Office, non agitarti! Per risolvere questo, puoi renderlo compatibile correggendo i errori del validatore o usando un tema compatibile con';
$_LANG['-- Select your country --'] = '-- scegliere il paese --';
$_LANG['-- Select your timezone --'] = '-- Scegli il fuso orario --';
$_LANG['Your database connection settings are not valid. Please check your server, name, login and prefix.'] = 'Le impostazioni della tua connessione non sono validi. Si prega di verificare il tuo server, nome, login e prefisso';
$_LANG['PrestaShop core is released under the OSL 3.0 while PrestaShop modules and themes are released under the AFL 3.0.'] = 'Il core PrestaShop è pubblicato sotto OSL 3.0, mentre I moduli e temi sono pubblicati sotto AFL 3.0';
$_LANG['Required set-up. Please verify the following checklist items:'] = 'Impostazioni riquieste., Si prega di verificare I seguenti elementi della checklist';
$_LANG['+33 (0)1.40.18.30.04'] = '+33 (0)1.40.18.30.04';
$_LANG['stable releases have been made available since.'] = 'Versioni stabili sono disponibili da';
$_LANG['Module compatibility'] = 'compatibilità del modulo';
$_LANG['It\'s dangerous to keep non-native modules activated during the update. If you really want to take this risk, uncheck the following box.'] = 'è pericoloso mantenere attivati dei moduli non-nativi durante l\'aggiornamento. Se vuoi proprio prendere questo rischio, deseleziona la casella seguente';
$_LANG['Theme compatibility'] = 'compatibilità del tema';
$_LANG['Before updating, you need to check that your theme is compatible with version'] = 'Prima dell\'aggiornamento, devi verificare que il tema è compatibile con la versione';
$_LANG['of PrestaShop.'] = 'di PrestaShop';
$_LANG['Link to the validator'] = 'link verso il validatore';
$_LANG['Online Theme Validator'] = 'validatore del tema online';
$_LANG['If your theme is invalid, you may experience some problems in your Front Office layout, but do not panic! To resolve this, you can make it compatible by fixing the validator errors or by using a theme compatible with '] = 'Se il tuo tema non è valido, puoi incontrare problemi nell\'impaginazione del tuo Front Office, ma non aggitarti! Per risolvere questo, puoi renderlo compatibile correggendo I errori del validatore o usando un tema compatibile con';
$_LANG['version'] = 'versione';
$_LANG['However the installer has detected that the version stored in your configuration table is %1$s'] = 'Comunque, l\'installatore ha rilevato che la versione registrata nella tua tabella di configurazione è %1$s';
$_LANG['Dom extension loaded'] = 'Estensione dom caricata';
$_LANG['Warning, we detected that the version specified in your config/settings.inc.php does not match your SQL database structure.<br />File config/settings.inc.php indicates: %1$s<br />Our automatic detection tool has detected version: %2$s<br /><br />You should edit your config/settings.inc.php file to replace %1$s by %2$s.<br />Failure to fix this issue before upgrading may result in severe complications.<br />Do not forget to relaunch the installer after this modification by pressing F5 on your web browser.'] = 'Attenzione, abbiamo rilevato che la versione specificata nel tuo config/settings.inc.php non è compatibile con la struttura del tuo database MySQL.<br/>Il file config/settings.inc.php indica: %1$s<br/>Il nostro strumento di rilevazione automatica ha rilevato la versione: %2$s<br/><br/>Dovresti modificare il tuo file config/settings.inc.php per rimpiazare %1$s da %2$s.<br/> Non risolvere questo problema prima dell\'aggiornamento puo\' creare complacazioni severe.<br/>Non dimenticare di rilanciare l\'installatore dopo questa modifica premendo F5 nel tuo navigator internet.';
$_LANG['Warning, we detected that the version specified in your config/settings.inc.php does not match your SQL database structure.<br />File config/settings.inc.php indicates: %1$s<br />Our automatic detection tool has detected a version between %2$s and %3$s<br /><br />You should edit your config/settings.inc.php file to replace %1$s by your real shop version.<br />Failure to fix this issue before upgrading may result in severe complications.<br />Do not forget to relaunch the installer after this modification by pressing F5 on your web browser.'] = 'Attenzione, abbiamo rilevato che la versione specificata nel tuo config/settings.inc.php non è compatibile con la struttura del tuo database MySQL.<br/>Il file config/settings.inc.php indica: %1$s<br/>Il nostro strumento di rilevazione automatica ha rilevato una versione tra %2$s e %3$s.<br/><br/> Dovresti modificare il tuo file config/settings.inc.php per rimpiazare %1$s con la vera versione del tuo negozio.<br/> Non risolvere questo problema prima dell\'aggiornamento puo\' creare complacazioni severe.<br/>Non dimenticare di rilanciare l\'installatore dopo questa modifica premendo F5 nel tuo navigator internet.';
$_LANG['Warning, the installer was unable to detect what is your current PrestaShop version from a database structure analysis. This means some fields or tables are missing, and upgrade is under your own risk.'] = 'Attenzione, l\'installatore no ha potuto rilevare qual\'è la tua versione di PrestaShop attuale durante l\'analisi della struttura della database. Questo significa che certi campi o tabelle sono mancanti, e l\'aggiornamento si farà a tuo rischio';
