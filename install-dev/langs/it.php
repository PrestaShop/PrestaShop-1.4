...
$_LANG['Required set-up. Please verify the following checklist items:'] = '';
$_LANG['+33 (0)1.40.18.30.04'] = '+33 (0)1.40.18.30.04';
$_LANG['stable releases have been made available since.'] = '';
$_LANG['Module compatibility'] = '';
$_LANG['It\'s dangerous to keep non-native modules activated during the update. If you really want to take this risk, uncheck the following box.'] = '';
$_LANG['Theme compatibility'] = '';
$_LANG['Before updating, you need to check that your theme is compatible with version'] = '';
$_LANG['of PrestaShop.'] = '';
$_LANG['Link to the validator'] = '';
$_LANG['Online Theme Validator'] = '';
$_LANG['If your theme is invalid, you may experience some problems in your Front Office layout, but do not panic! To resolve this, you can make it compatible by fixing the validator errors or by using a theme compatible with '] = '';
$_LANG['version'] = '';
