...
$_LANG['the already installed version detected is too old, no more update available'] = 'La versione gi� installata individuata � troppo vecchia, non ci sono pi� aggiornamenti disponibili';
...
$_LANG['Simple mode: Basic installation'] = 'Modalit� semplice: installazione base';
$_LANG['(FREE)'] = '(GRATUITO)';
$_LANG['Full mode: includes'] = 'Modalit� completa: include';
$_LANG['100+ additional modules'] = 'Pi� di 100 moduli aggiuntivi';
$_LANG['and demo products'] = 'e prodotti demo';
$_LANG['(FREE too!)'] = 'GRATUITI!';
$_LANG['Shop configuration'] = 'Configurazione negozio';
$_LANG['I certify that I backed up my database and application files. I assume all responsibility for any data loss or damage related to this upgrade.'] = 'Dichiaro di aver effettuato il backup del mio database e dei file di applicazione. Mi assumo tutte le responsabilit� per qualsiasi perdita dei dati o danni relativi a questo aggiornamento';
...
$_LANG['major releases have been made available since.'] = 'Sono state messe a disposizione importanti novit�';
$_LANG['This is not a problem however the update may take several minutes, try to update your shop more frequently.'] = 'Questo non � un problema, comunque l�aggiornamento pu� impiegare diversi minuti: cerca di aggiornare il tuo negozio pi� spesso';
...
$_LANG['Your update is completed!'] = 'L\'aggiornamento � completo!';
$_LANG['Your shop version is now'] = 'La tua versione adesso �';
