...
$_LANG['(root of this application)'] = '(Root dieser Anwendung)';
$_LANG['.'] = '.';
$_LANG['A Prestashop database already exists, please drop it or change the prefix.'] = 'Eine PrestaShop Datenbank existiert bereits mit diesem Präfix, müssen Sie manuell löschen oder das Präfix ändern.';
$_LANG['An email has been sent!'] = 'Eine E-Mail wurde verschickt!';
$_LANG['Access and configure PHP 5.0+ on your hosting server'] = 'Prüfen Sie, ob Ihr Provider PHP5 anbietet und/ oder aktivieren';
...
$_LANG['And now, discover your new store and Back Office'] = 'Hier ist Ihr neuer Online-Shop und sein Back-Office';
$_LANG['Available shop languages'] = 'Angebotene Sprachen';
$_LANG['Back'] = 'Zurück';
...
$_LANG['Impossible to copy languages\'s flags.'] = 'Fahnen der Sprachen können nicht kopiert werden';
...
$_LANG['Your Back Office'] = 'Mein Back-Office';
$_LANG['Your shop'] = 'Mein Shop';
...
$_LANG['Surname'] = 'Name des Verkäufers';
...
$_LANG['Your database server does not support the utf-8 charset.'] = 'Ihre Datenbank-Server unterstützt keinen UTF-8-Zeichensatz.';
$_LANG['Improve your user experience and your visitors\', discover our websites and services:'] = 'Erhöhen Sie Ihre Erfahrungen und die Ihrer Besucher, entdecken Sie unsere Webseiten und Dienste:';
$_LANG['Be different with a'] = 'Machen Sie auf sich aufmerksam mit einer';
$_LANG['design'] = 'Corporate Identity';
$_LANG['which fit with your shop and find the'] = 'die Ihrem Sektor entspricht und finden Sie das';
$_LANG['payment mean'] = 'Zahlungsmittel,';
$_LANG['you like the most.'] = 'das Ihnen am meisten entspricht.';
$_LANG['Themes'] = 'Themen';
$_LANG['Payment modules'] = 'Zahlungsmodule';
...
$_LANG['Adult'] = 'Erwachsene und Dessous';
...
$_LANG['If you don\'t know how to fix these issues,<br />you can use our hosted PrestaShop service on'] = 'Wenn Sie nicht wissen, wie Sie diese Probleme beheben können, <br/>können Sie unseren auf   gehosteten PrestaShop-Service nutzen';
...
$_LANG['Yes'] = 'Ja';
$_LANG['No'] = 'Nein';
$_LANG['If you activate this feature, all purchases features will be disabled. You can activate this feature later in your back office'] = 'Wenn Sie diese Option aktivieren, werden alle Kauf-Funktionen deaktiviert. Sie können diese Option später in Ihrem Back-Office aktivieren';
