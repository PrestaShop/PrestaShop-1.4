...
$_LANG['If you do not know how to enable it, use our turnkey solution PrestaBox at'] = 'Wenn Sie nicht wissen, wie Sie es aktivieren m�ssen, nutzen Sie unsere Fertigl�sung PrestaBox';
$_LANG['Invalid shop name'] = 'Ung�ltiger Shopname';
$_LANG['Your firstname contains some invalid characters'] = 'Ihr Vorname enth�lt einige ung�ltige Zeichen';
$_LANG['Your lastname contains some invalid characters'] = 'Ihr Nachname enth�lt einige ung�ltige Zeichen';
...
$_LANG['the already installed version detected is too old, no more update available'] = 'Die bereits installierte erkannte Version ist zu alt, es ist kein Update mehr verf�gbar';
...
$_LANG['100+ additional modules'] = '100+zus�tzliche Module';
$_LANG['and demo products'] = 'und Demo-Produkte';
$_LANG['(FREE too!)'] = '(ebenfalls KOSTENLOS!)';
$_LANG['Shop configuration'] = 'Shop-Konfiguration';
$_LANG['I certify that I backed up my database and application files. I assume all responsibility for any data loss or damage related to this upgrade.'] = 'Ich best�tige, dass ich meine Datenbank und meine Anwendungsdateien durch ein Backup gesichert habe. Ich �bernehme die volle Verantwortung f�r jeglichen Datenverlust oder jegliche Datenbesch�digung, die im Zusammenhang mit diesem Upgrade stehen.';
