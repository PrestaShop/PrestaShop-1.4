...
$_LANG['Warning, the installer found in your setting file that your PrestaShop is in version %s, but the database analysis say you seem to be in version %s. Be sure of what you are doing if you start upgrade.<br />If you never tried an update to this new version, or never made modifications in your base, please ignore this warning.'] = "Attention, l'installateur a détecté que votre version de PrestaShop dans le fichier settings.ini était la version %s, alors qu'il semblerait qu'après une analyse de votre de donnée vous soyez en version %s. Soyez sûr de ce que vous faîtes en lançant la mise à jour.<br /><br />S'il s'agit de votre première mise à jour vers cette nouvelle version, où que vous n'avez jamais fait de modifications manuelles de votre base de donnée, veuillez ignorer cet avertissement.";
