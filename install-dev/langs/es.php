...
$_LANG['Prestashop and its community offers over 60 different languages for free download at'] = 'La comunidad Prestashop ofrece más de 60 idiomas diferentes para su descarga gratuita en';
...
$_LANG['stable releases have been made available since.'] = 'versiones estables han sido puestas a disposición desde.';
...
$_LANG['Your database connection settings are not valid. Please check your server, name, login and prefix.'] = 'La configuración de conexión de su base de datos no es válida. Por favor, verifique su servidor, el nombre de inicio de sesión y el prefijo';
$_LANG['PrestaShop core is released under the OSL 3.0 while PrestaShop modules and themes are released under the AFL 3.0.'] = 'El núcleo de PrestaShop es publicado bajo la OSL 3.0, mientras que los módulos y plantillas son publicados bajo la AFL 3.0.';
$_LANG['Warning, we detected that the version specified in your config/settings.inc.php does not match your SQL database structure.<br />File config/settings.inc.php indicates: %1$s<br />Our automatic detection tool has detected version: %2$s<br /><br />You should edit your config/settings.inc.php file to replace %1$s by %2$s.<br />Failure to fix this issue before upgrading may result in severe complications.<br />Do not forget to relaunch the installer after this modification by pressing F5 on your web browser.'] = 'Alerta, se detectó que la versión especificada en la configuración / settings.inc.php no coincide con la estructura de su base de datos SQL.<br />El archivo config / settings.inc.php indica: %1$s<br />Nuestra herramienta de detección automática ha detectado la versión: %2$s<br /><br /> Usted debe editar el archivo config / settings.inc.php para remplazar %1$s por %2$s <br />Un error al solucionar este problema antes de la actualización puede dar lugar a complicaciones graves.<br />No olvide relanzar el programa de instalación después de esta modificación pulsando F5 en el navegador web.';
$_LANG['Warning, we detected that the version specified in your config/settings.inc.php does not match your SQL database structure.<br />File config/settings.inc.php indicates: %1$s<br />Our automatic detection tool has detected a version between %2$s and %3$s<br /><br />You should edit your config/settings.inc.php file to replace %1$s by your real shop version.<br />Failure to fix this issue before upgrading may result in severe complications.<br />Do not forget to relaunch the installer after this modification by pressing F5 on your web browser.'] = 'Alerta, se detectó que la versión especificada en la configuración / settings.inc.php no coincide con la estructura de su base de datos SQL.<br />El archivo config/settings.inc.php indica: %1$s<br Nuestra herramienta de detección automática ha detectado una versión entre el %2$s, y %3$s<br /><br />Usted debe editar el archivo config / settings.inc.php para remplazar %1$s por la versión real de su tienda.<br />Un error al solucionar este problema antes de la actualización puede dar lugar a complicaciones graves.<br />No olvide relanzar el programa de instalación después de esta modificación pulsando F5 en el navegador web.';
$_LANG['Warning, the installer was unable to detect what is your current PrestaShop version from a database structure analysis. This means some fields or tables are missing, and upgrade is under your own risk.'] = 'Advertencia, el instalador no pudo detectar cuál es la versión actual de PrestaShop después de un análisis de la estructura de base de datos. Esto significa que algunos campos o tablas han desaparecido, y la actualización se hará bajo su propio riesgo.';
$_LANG['However the installer has detected that the version stored in your configuration table is %1$s'] = 'Sin embargo, el instalador ha detectado que la versión almacenada en su tabla de configuración es %1$s';
$_LANG['Dom extension loaded'] = 'Extensión Dom descargada';
$_LANG['translations'] = 'traducciones';
$_LANG['-- Select your country --'] = '-- Escoja su país --';
$_LANG['-- Select your timezone --'] = '-- Escoja su huso horario --';
