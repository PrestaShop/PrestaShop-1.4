...
$_LANG['Choose your prefered language for the installation:'] = '¬øEn qu√© idioma quiere efectuar la instalación?';
...
$_LANG['Database server was not found. Please verify the login, password and server fields.'] = 'La base de datos de servidor no se ha encontrado, por favor, compruebe sus datos de acceso o el nombre de servidor.';
...
$_LANG['E-mail configuration'] = 'Parámetros de env√≠o de emails';
...
$_LANG['Here is your shop information. You can modify it once you are logged in.'] = 'Aqu√≠ tiene sus datos de conexión, puede modificarlos posteriormente si lo desea.';
$_LANG['However, you must know how to do the following:'] = 'No obstante, puede efectuar las siguientes tareas:';
...
$_LANG['Cannot write the image /img/logo.jpg. If this image already exists, please delete it.'] = 'No se puede escribir la imagen /img/logo.jpg. Si ya existe, por favor, supr√≠mala manualmente.';
...
$_LANG['Please allow 10-15 minutes to complete the installation process.'] = 'El proceso de instalación tardará tan solo unos minutos.';
...
$_LANG['Receive this information by e-mail'] = 'Recibir sus datos por email';
...
$_LANG['Set permissions on folders & subfolders using an FTP client'] = 'Poner los permisos en las carpetas y subcarpetas v√≠a un cliente FTP';
...
$_LANG['The PrestaShop Installer will do most of the work for you in just a few clicks.'] = 'El instalador de PrestaShop hará todo el trabajo en tan solo algunos clics.';
...
$_LANG['WARNING: For security purposes, you must delete the "install" folder.'] = 'ATENCION : para más seguridad, por favor suprima la carpeta \'/install\'.';
...
$_LANG['You have just installed and configured PrestaShop as your online shop. We wish you all the best with the success of your online shop.'] = 'Acaba de instalar y de configurar su tienda en l√≠nea y se lo agradecemos.';
$_LANG['You have just updated and configured PrestaShop as your online shop. We wish you all the best with the success of your online shop.'] = 'Deba actualizar su tienda en l√≠nea. Se lo agradecemos.';
...
$_LANG['Recommended dimensions:'] = 'Dimensiones aconsajables:';
...
$_LANG['Manage your store using your Back Office. Manage your orders and customers, add modules, change themes, etc.'] = 'Administre su tienda con su back office. Gestione pedidos y clientes, agregue módulos, cambie el tema, etc ...';
...
$_LANG['Discover your store'] = 'Descubra su tienda';
$_LANG['Warning: If you check this box and your e-mail configuration is incorrect, you might not be able to continue the installation.'] = 'Esta opción se puede bloquear si su configuración de correo electrónico está mal, gracias a desactivarla si usted no puede moverse a la siguiente etapa.';
...
$_LANG['(FREE)'] = '(GRATIS)';
$_LANG['Full mode: includes core modules,'] = 'Modo completo: incluido';
...
$_LANG['This information is not required, it will only be used for statistical purposes. This information does not change anything in your store.'] = 'Esta información no es obligatoria, solo se utilizará para estad√≠sticas. Proporcionarla o no, no cambiará nada en su tienda.';
$_LANG['E-mail:'] = 'Email :';
...
$_LANG['Your update is complete!'] = 'La actualización ha concluido con √©xito';
...
$_LANG['Ok, please deactivate the following modules, I will reactivate them later:'] = 'De acuerdo, desactive automáticamente los siguientes módulos, los activar√© yo mismo más tarde:';
...
$_LANG['If your theme is invalid, you may experience some problems in your Front Office layout, but do not panic! To resolve this, you can make it compatible by fixing the validator errors or by using a theme compatible with '] = 'Si su tema no es válido, podr√≠a tener problemas en la página de su sitio Web, pero no se preocupe, ¬°puede hacerlo compatible corrigiendo los errores se√±alados por el validador o utilizando un tema compatible con la versión!' ;
