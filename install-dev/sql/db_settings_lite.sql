...
(19, 7, 'CH', 41, 1, 0, 0),(20, 1, 'DK', 45, 1, 0, 0),(21, 2, 'US', 1, 1, 1, 0),(22, 3, 'HK', 852, 1, 0, 0),(23, 1, 'NO', 47, 1, 0, 0),(24, 5, 'AU', 61, 1, 0, 0),
(25, 3, 'SG', 65, 1, 0, 0),(26, 7, 'IE', 353, 1, 0, 0),(27, 5, 'NZ', 64, 1, 0, 0),(28, 3, 'KR', 82, 1, 0, 0),(29, 3, 'IL', 972, 1, 0, 0),(30, 4, 'ZA', 27, 1, 0, 0),
(31, 4, 'NG', 234, 1, 0, 0),(32, 4, 'CI', 225, 1, 0, 0),(33, 4, 'TG', 228, 1, 0, 0),(34, 6, 'BO', 591, 1, 0, 0),(35, 4, 'MU', 230, 1, 0, 0),(36, 1, 'RO', 40, 1, 0, 0),
(37, 1, 'SK', 421, 1, 0, 0),(38, 4, 'DZ', 213, 1, 0, 0),(39, 2, 'AS', 0, 1, 0, 0),(40, 7, 'AD', 376, 1, 0, 0),(41, 4, 'AO', 244, 1, 0, 0),(42, 8, 'AI', 0, 1, 0, 0),
(43, 2, 'AG', 0, 1, 0, 0),(44, 6, 'AR', 54, 1, 0, 0),(45, 3, 'AM', 374, 1, 0, 0),(46, 8, 'AW', 297, 1, 0, 0),(47, 3, 'AZ', 994, 1, 0, 0),(48, 2, 'BS', 0, 1, 0, 0),
(49, 3, 'BH', 973, 1, 0, 0),(50, 3, 'BD', 880, 1, 0, 0),(51, 2, 'BB', 0, 1, 0, 0),(52, 7, 'BY', 0, 1, 0, 0),(53, 8, 'BZ', 501, 1, 0, 0),(54, 4, 'BJ', 229, 1, 0, 0),
(55, 2, 'BM', 0, 1, 0, 0),(56, 3, 'BT', 975, 1, 0, 0),(57, 4, 'BW', 267, 1, 0, 0),(58, 6, 'BR', 55, 1, 0, 0),(59, 3, 'BN', 673, 1, 0, 0),(60, 4, 'BF', 226, 1, 0, 0),
(61, 3, 'MM', 95, 1, 0, 0),(62, 4, 'BI', 257, 1, 0, 0),(63, 3, 'KH', 855, 1, 0, 0),(64, 4, 'CM', 237, 1, 0, 0),(65, 4, 'CV', 238, 1, 0, 0),(66, 4, 'CF', 236, 1, 0, 0),
(67, 4, 'TD', 235, 1, 0, 0),(68, 6, 'CL', 56, 1, 0, 0),(69, 6, 'CO', 57, 1, 0, 0),(70, 4, 'KM', 269, 1, 0, 0),(71, 4, 'CD', 242, 1, 0, 0),(72, 4, 'CG', 243, 1, 0, 0),
(73, 8, 'CR', 506, 1, 0, 0),(74, 7, 'HR', 385, 1, 0, 0),(75, 8, 'CU', 53, 1, 0, 0),(76, 1, 'CY', 357, 1, 0, 0),(77, 4, 'DJ', 253, 1, 0, 0),(78, 8, 'DM', 0, 1, 0, 0),
(79, 8, 'DO', 0, 1, 0, 0),(80, 3, 'TL', 670, 1, 0, 0),(81, 6, 'EC', 593, 1, 0, 0),(82, 4, 'EG', 20, 1, 0, 0),(83, 8, 'SV', 503, 1, 0, 0),(84, 4, 'GQ', 240, 1, 0, 0),
(85, 4, 'ER', 291, 1, 0, 0),(86, 1, 'EE', 372, 1, 0, 0),(87, 4, 'ET', 251, 1, 0, 0),(88, 8, 'FK', 0, 1, 0, 0),(89, 7, 'FO', 298, 1, 0, 0),(90, 5, 'FJ', 679, 1, 0, 0),
(91, 4, 'GA', 241, 1, 0, 0),(92, 4, 'GM', 220, 1, 0, 0),(93, 3, 'GE', 995, 1, 0, 0),(94, 4, 'GH', 233, 1, 0, 0),(95, 8, 'GD', 0, 1, 0, 0),(96, 7, 'GL', 299, 1, 0, 0),
(97, 7, 'GI', 350, 1, 0, 0),(98, 8, 'GP', 590, 1, 0, 0),(99, 8, 'GU', 0, 1, 0, 0),(100, 8, 'GT', 502, 1, 0, 0),(101, 7, 'GG', 0, 1, 0, 0),(102, 4, 'GN', 224, 1, 0, 0),
(103, 4, 'GW', 245, 1, 0, 0),(104, 6, 'GY', 592, 1, 0, 0),(105, 8, 'HT', 509, 1, 0, 0),(106, 5, 'HM', 0, 1, 0, 0),(107, 7, 'VA', 379, 1, 0, 0),(108, 8, 'HN', 504, 1, 0, 0),
(109, 7, 'IS', 354, 1, 0, 0),(110, 3, 'IN', 91, 1, 0, 0),(111, 3, 'ID', 62, 1, 0, 0),(112, 3, 'IR', 98, 1, 0, 0),(113, 3, 'IQ', 964, 1, 0, 0),(114, 7, 'IM', 0, 1, 0, 0),
(115, 8, 'JM', 0, 1, 0, 0),(116, 7, 'JE', 0, 1, 0, 0),(117, 3, 'JO', 962, 1, 0, 0),(118, 3, 'KZ', 7, 1, 0, 0),(119, 4, 'KE', 254, 1, 0, 0),(120, 7, 'KI', 686, 1, 0, 0),
(121, 3, 'KP', 850, 1, 0, 0),(122, 3, 'KW', 965, 1, 0, 0),(123, 3, 'KG', 996, 1, 0, 0),(124, 3, 'LA', 856, 1, 0, 0),(125, 1, 'LV', 371, 1, 0, 0),(126, 3, 'LB', 961, 1, 0, 0),
(127, 4, 'LS', 266, 1, 0, 0),(128, 4, 'LR', 231, 1, 0, 0),(129, 4, 'LY', 218, 1, 0, 0),(130, 1, 'LI', 423, 1, 0, 0),(131, 1, 'LT', 370, 1, 0, 0),(132, 3, 'MO', 853, 1, 0, 0),
(133, 7, 'MK', 389, 1, 0, 0),(134, 4, 'MG', 261, 1, 0, 0),(135, 4, 'MW', 265, 1, 0, 0),(136, 3, 'MY', 60, 1, 0, 0),(137, 3, 'MV', 960, 1, 0, 0),(138, 4, 'ML', 223, 1, 0, 0),
(139, 1, 'MT', 356, 1, 0, 0),(140, 5, 'MH', 692, 1, 0, 0),(141, 8, 'MQ', 596, 1, 0, 0),(142, 4, 'MR', 222, 1, 0, 0),(143, 1, 'HU', 36, 1, 0, 0),(144, 4, 'YT', 262, 1, 0, 0),
(145, 2, 'MX', 52, 1, 0, 0),(146, 5, 'FM', 691, 1, 0, 0),(147, 7, 'MD', 373, 1, 0, 0),(148, 7, 'MC', 377, 1, 0, 0),(149, 3, 'MN', 976, 1, 0, 0),(150, 7, 'ME', 382, 1, 0, 0),
(151, 8, 'MS', 0, 1, 0, 0),(152, 4, 'MA', 212, 1, 0, 0),(153, 4, 'MZ', 258, 1, 0, 0),(154, 4, 'NA', 264, 1, 0, 0),(155, 5, 'NR', 674, 1, 0, 0),(156, 3, 'NP', 977, 1, 0, 0),
(157, 8, 'AN', 599, 1, 0, 0),(158, 5, 'NC', 687, 1, 0, 0),(159, 8, 'NI', 505, 1, 0, 0),(160, 4, 'NE', 227, 1, 0, 0),(161, 5, 'NU', 683, 1, 0, 0),(162, 5, 'NF', 0, 1, 0, 0),
(163, 5, 'MP', 0, 1, 0, 0),(164, 3, 'OM', 968, 1, 0, 0),(165, 3, 'PK', 92, 1, 0, 0),(166, 5, 'PW', 680, 1, 0, 0),(167, 3, 'PS', 0, 1, 0, 0),(168, 8, 'PA', 507, 1, 0, 0),
(169, 5, 'PG', 675, 1, 0, 0),(170, 6, 'PY', 595, 1, 0, 0),(171, 6, 'PE', 51, 1, 0, 0),(172, 3, 'PH', 63, 1, 0, 0),(173, 5, 'PN', 0, 1, 0, 0),(174, 8, 'PR', 0, 1, 0, 0),
(175, 3, 'QA', 974, 1, 0, 0),(176, 4, 'RE', 262, 1, 0, 0),(177, 7, 'RU', 7, 1, 0, 0),(178, 4, 'RW', 250, 1, 0, 0),(179, 8, 'BL', 0, 1, 0, 0),(180, 8, 'KN', 0, 1, 0, 0),
(181, 8, 'LC', 0, 1, 0, 0),(182, 8, 'MF', 0, 1, 0, 0),(183, 8, 'PM', 508, 1, 0, 0),(184, 8, 'VC', 0, 1, 0, 0),(185, 5, 'WS', 685, 1, 0, 0),(186, 7, 'SM', 378, 1, 0, 0),
(187, 4, 'ST', 239, 1, 0, 0),(188, 3, 'SA', 966, 1, 0, 0),(189, 4, 'SN', 221, 1, 0, 0),(190, 7, 'RS', 381, 1, 0, 0),(191, 4, 'SC', 248, 1, 0, 0),(192, 4, 'SL', 232, 1, 0, 0),
(193, 1, 'SI', 386, 1, 0, 0),(194, 5, 'SB', 677, 1, 0, 0),(195, 4, 'SO', 252, 1, 0, 0),(196, 8, 'GS', 0, 1, 0, 0),(197, 3, 'LK', 94, 1, 0, 0),(198, 4, 'SD', 249, 1, 0, 0),
(199, 8, 'SR', 597, 1, 0, 0),(200, 7, 'SJ', 0, 1, 0, 0),(201, 4, 'SZ', 268, 1, 0, 0),(202, 3, 'SY', 963, 1, 0, 0),(203, 3, 'TW', 886, 1, 0, 0),(204, 3, 'TJ', 992, 1, 0, 0),
(205, 4, 'TZ', 255, 1, 0, 0),(206, 3, 'TH', 66, 1, 0, 0),(207, 5, 'TK', 690, 1, 0, 0),(208, 5, 'TO', 676, 1, 0, 0),(209, 6, 'TT', 0, 1, 0, 0),(210, 4, 'TN', 216, 1, 0, 0),
(211, 7, 'TR', 90, 1, 0, 0),(212, 3, 'TM', 993, 1, 0, 0),(213, 8, 'TC', 0, 1, 0, 0),(214, 5, 'TV', 688, 1, 0, 0),(215, 4, 'UG', 256, 1, 0, 0),(216, 1, 'UA', 380, 1, 0, 0),
(217, 3, 'AE', 971, 1, 0, 0),(218, 6, 'UY', 598, 1, 0, 0),(219, 3, 'UZ', 998, 1, 0, 0),(220, 5, 'VU', 678, 1, 0, 0),(221, 6, 'VE', 58, 1, 0, 0),(222, 3, 'VN', 84, 1, 0, 0),
(223, 2, 'VG', 0, 1, 0, 0),(224, 2, 'VI', 0, 1, 0, 0),(225, 5, 'WF', 681, 1, 0, 0),(226, 4, 'EH', 0, 1, 0, 0),(227, 3, 'YE', 967, 1, 0, 0),(228, 4, 'ZM', 260, 1, 0, 0),
(229, 4, 'ZW', 263, 1, 0, 0),(230, 7, 'AL', 355, 1, 0, 0),(231, 3, 'AF', 93, 1, 0, 0),(232, 5, 'AQ', 0, 1, 0, 0),(233, 1, 'BA', 387, 1, 0, 0),(234, 5, 'BV', 0, 1, 0, 0),
(235, 5, 'IO', 0, 1, 0, 0),(236, 1, 'BG', 359, 1, 0, 0),(237, 8, 'KY', 0, 1, 0, 0),(238, 3, 'CX', 0, 1, 0, 0),(239, 3, 'CC', 0, 1, 0, 0),(240, 5, 'CK', 682, 1, 0, 0),
(241, 6, 'GF', 594, 1, 0, 0),(242, 5, 'PF', 689, 1, 0, 0),(243, 5, 'TF', 0, 1, 0, 0),(244, 7, 'AX', 0, 1, 0, 0);
...
(53, 'AdminBackup', 9, 8),(57, 'AdminCMS', 9, 9),(64, 'AdminGenerator', 9, 10),(43, 'AdminSearch', -1, 0),(69, 'AdminInformation', 9, 11);
...
(1, 68, 'Attachments'),(1, 69, 'Informations'),(2, 1, 'Catalogue'),(2, 2, 'Clients'),(2, 3, 'Commandes'),(2, 4, 'Paiement'),(2, 5, 'Transport'),(2, 6, 'Stats'),
...
(2, 68, 'Documents joints'),(2, 69, 'Informations'),(3, 1, 'Catálogo'),(3, 2, 'Clientes'),(3, 3, 'Pedidos'),(3, 4, 'Pago'),(3, 5, 'Transporte'),(3, 6, 'Estadísticas'),
...
(3, 61, 'Motores de búsqueda'),(3, 62, 'Referido'),(3, 63, 'Grupos'),(3, 64, 'Generadores'),(3, 65, 'Carritos'),(3, 66, 'Etiquetas'),(3, 67, 'Búsqueda'),(3, 68, 'Adjuntos'),(3, 69, 'Informations');
