...
CHANGE `id_product` `id_product` INT(10) UNSIGNED NOT NULL,
CHANGE `id_attribute` `id_attribute` INT(10) UNSIGNED NOT NULL;
...
CHANGE `id_discount` `id_discount` int(10) unsigned NOT NULL;

ALTER TABLE `PREFIX_module_group` 
CHANGE `id_group` `id_group` int(10) unsigned NOT NULL;
...
CHANGE `id_connections_source` `id_connections_source` int(10) unsigned NOT NULL,
CHANGE `id_referrer` `id_referrer` int(10) unsigned NOT NULL;
...
CHANGE `id_product` `id_product` int(10) unsigned NOT NULL,
CHANGE `id_word` `id_word` int(10) unsigned NOT NULL;

ALTER TABLE `PREFIX_state` 
CHANGE `id_country` `id_country` int(10) unsigned NOT NULL,
CHANGE `id_zone` `id_zone` int(10) unsigned NOT NULL;
