...
function editorial_update()
{
	...
	if (Db::getInstance()->getValue('SELECT `id_module` FROM `'._DB_PREFIX_.'module` WHERE `name`="editorial"') AND file_exists(dirname(__FILE__).'/../../modules/editorial/editorial.xml'))
	{
		...
		foreach ($languages as $language)
			...
			VALUES (1, '.intval($language['id_lang']).', 
