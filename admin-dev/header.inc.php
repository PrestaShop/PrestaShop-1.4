	...
	<div id="top_container">
		<div id="container">
			<div id="header_infos"><span>
				...
				- <a href="index.php?tab=AdminEmployees&id_employee='.(int)$cookie->id_employee.'&updateemployee&token='.Tools::getAdminTokenLite('AdminEmployees').'" style="font-size: 10px;"><img src="../img/admin/employee-icon.png" alt="" /> '.translate('My preferences').'</a>
			</span></div>
