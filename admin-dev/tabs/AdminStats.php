...
class AdminStats extends AdminStatsTab
{
	...
	public function display()
	{
		...
		<div style="float:left;margin-left:40px;width:600px">
			<fieldset><legend><img src="../img/admin/tab-stats.gif" /> '.$this->l('Help').'</legend>
			...
			<br /><br />
			<fieldset><legend><img src="../img/admin/___info-ca.gif" style="vertical-align: middle" /> '.$this->l('Sales').'</legend>
				<table>
			...
			<br /><br />
			<fieldset><legend><img src="../img/admin/products.gif" style="vertical-align: middle" /> '.$this->l('Carts').'</legend>
		...
		if (strtolower($cookie->stats_granularity) != 'd' AND $records AND is_array($records))
		{
			echo '
			<br /><br />
			<fieldset><legend><img src="../img/admin/medal.png" style="vertical-align: middle" />'.$this->l('Records').'</legend>
				<table cellspacing="0" cellpadding="0" class="table">
					<tr>
						<th style="width: 150px"></th>
