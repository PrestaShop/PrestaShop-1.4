...
class AdminCMSContent extends AdminTab
{
	...
	{
		if (Tools::isSubmit('submitDelcms') OR Tools::isSubmit('fakeSubmitAddcmsAndPreview') OR Tools::isSubmit('submitAddcms') OR isset($_GET['deletecms']) OR Tools::isSubmit('viewcms') OR (Tools::isSubmit('status') AND Tools::isSubmit('id_cms')) OR (Tools::isSubmit('position') AND !Tools::isSubmit('id_cms_category_to_move')))
