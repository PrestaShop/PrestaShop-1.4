...
/**
  * Stores tab for admin panel, AdminStores.php
  * @category admin
  *
...
class AdminStores extends AdminTab
{
	...
	public function __construct()
	{
		...
		$this->fieldsDisplay = array(
			...
			'country' => array('title' => $this->l('Country'), 'width' => 120),
			'state' => array('title' => $this->l('State'), 'width' => 120),
		...
		$this->_fieldsOptions = array(
			...
			'PS_STORES_DISPLAY_CMS' => array('title' => $this->l('Display in CMS block module:'), 'desc' => $this->l('Display at the end of the CMS module block'), 'cast' => 'intval', 'type' => 'bool'),
