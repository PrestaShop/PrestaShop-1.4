	...
	public function __construct()
	{
		...
		$this->table = 'configuration';
 		...
 		$this->_fieldsProduct = array(
			...
			'PS_ATTRIBUTE_CATEGORY_DISPLAY' => array('title' => $this->l('Display "add to cart" button when product has attributes:'), 'desc' => $this->l('Display or undisplay the button "add to cart" on category pages for products who have attributes to force customers to see the product detail'), 'validation' => 'isBool', 'cast' => 'intval', 'type' => 'bool'),
