	...
	public function __construct()
	{
		...
		$this->table = 'configuration';
 		...
 		$this->_fieldsProduct = array(
			...
			'PS_PURCHASE_MINIMUM' => array('title' => $this->l('Minimum purchase required to validate order:'), 'desc' => $this->l('Set to 0 to disable this feature'), 'validation' => 'isFloat', 'cast' => 'floatval', 'type' => 'price'),
