...
class AdminPreferences extends AdminTab
{
	public function __construct()
	{
		...
		$this->_fieldsGeneral = array(
			...
			'PS_SHOP_DOMAIN_SSL' => array('title' => $this->l('Shop domain namefor SSL'), 'desc' => $this->l('Domain name for the secured area of your shop, used as a canonical URL (e.g., secure.myshop.com). Keep it blank if you don\'t know what to do.'), 'validation' => 'isUrl', 'type' => 'text', 'size' => 30, 'default' => ''),
