...
class AdminPreferences extends AdminTab
{
	public function __construct()
	{
		...
		$this->_fieldsGeneral = array(
			...
			'PS_COOKIE_CHECKIP' => array('title' => $this->l('Check IP on the cookie'), 'desc' => $this->l('Check the IP address of the cookie in order to avoid your cookie be stolen'), 'validation' => 'isBool', 'cast' => 'intval', 'type' => 'bool', 'default' => '0'),
