...
{		
	...
	var idAddress = parseInt($('select#id_address_' + addressType + '').val());
...
{
	var idAddress_delivery = parseInt($('select#id_address_delivery').val());
	var idAddress_invoice = $('input[type=checkbox]#addressesAreEquals:checked').length == 1 ? idAddress_delivery : parseInt($('select#id_address_invoice').val());
