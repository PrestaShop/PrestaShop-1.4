...
<form action="{$link->getPageLink('address.php', true)}" method="post" class="std">
	...
	{/if}
		...
		<p class="required text" id="address_alias">
			...
			<input type="text" id="alias" name="alias" value="{if isset($smarty.post.alias)}{$smarty.post.alias}{else}{if isset($address->alias)}{$address->alias|escape:'htmlall':'UTF-8'}{/if}{if !$select_address}{l s='My address'}{/if}{/if}" />
			<sup>*</sup>
		</p>
	</fieldset>
